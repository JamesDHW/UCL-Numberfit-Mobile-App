      ...
      _createClass(PlaySinglePage, [{
        ...
        value: function play() {
          ...
          while (this.answer.length != 4) {
            ...
            var ques = this.bucket + "/" + subject + "/" + this.user.year + "/beg/" + "PDF-" + page + "-" + card + ".png";
            var ans = this.bucket + "/" + subject + "/" + this.user.year + "/beg/" + "PDF-" + (page + 2) + "-" + (card + 2) + ".png";
        ...
        value: function checkWin() {
          ...
          if (this.imgState >= 12) {
            ...
            this.sleep(8000).then(function () {
              ...
              _this2.router.navigateByUrl('/play');
