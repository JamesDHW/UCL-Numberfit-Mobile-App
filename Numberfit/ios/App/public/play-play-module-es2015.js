...
let HomePage = class HomePage {
    constructor(screenOrientation, router, http, nativeStorage) {
        ...
        this.nativeStorage.getItem('user')
            .then((data) => {
            this.user = data;
            if (this.user.points > __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank1_above) {
                this.rank = __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank1_title;
                this.rankImage = "./assets/score/master.png";
            }
            else if (this.user.points > __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank2_above) {
                this.rank = __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank2_title;
                this.rankImage = "./assets/score/expert.png";
            }
            else if (this.user.points > __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank3_above) {
                this.rank = __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank3_title;
                this.rankImage = "./assets/score/advanced.png";
            }
            else {
                this.rank = __webpack_require__(/*! ../config.json */ "./src/app/config.json").nf_rank4_title;
